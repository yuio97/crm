...
<body>
<div class="wangid_conbox" id="deptList">
	<!-- 当前位置 -->
	...
	<table class="layui-table" lay-filter="mylist" lay-size="lg">
		<thead>
			<tr>
				<th><button class="layui-btn layui-btn-sm" @click="del">删除</button> </th>
				<th lay-data="{field:'yx', align:'center',minWidth:60}">部门编号</th>
				<th lay-data="{field:'time',align:'center', minWidth:160}">部门名称</th>
				<th lay-data="{field:'www',align:'center',minWidth:260}" style="text-align: center;">部门简介</th> 
				<th lay-data="{field:'option',align:'center',width:130,fixed: 'right'}">操作</th>
			</tr> 
		</thead>
		<tbody>
